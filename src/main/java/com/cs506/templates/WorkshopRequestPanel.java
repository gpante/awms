...
public class WorkshopRequestPanel extends Panel {
	...
	public final class WorkshopRequestForm extends Form<WorkshopRequest> {
		...
		public WorkshopRequestForm(String id) {
			...
			RadioGroup<Boolean> consist75Group = new RadioGroup<>("consist75",
					new PropertyModel(getModel(), "consist75"));
			...
			RadioGroup<WorkshopType> workshopTypeGroup = new RadioGroup<>("workshopType",
					new PropertyModel(getModel(), "workshopType"));
			...
			final MarkupContainer alternateStartTimeFeedback = new FormComponentFeedbackBorder(
					"alternateStartTimeFeedback");
			...
			final MarkupContainer alternateEndTimeFeedback = new FormComponentFeedbackBorder(
					"alternateEndTimeFeedback");
